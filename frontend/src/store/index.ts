...
// Stores Zustand con API Backend (FIX COMPLETO)
// ============================================
...
// FIX: Mapear exactamente al tipo Cliente
...
set({ isLoading: true, error: null });
try {
// Enviar en formato exacto que espera el backend (schemas.py)
...
// Mapear respuesta exactamente al tipo Cliente
...
// FIX: Mapear según schemas.py y types/index.ts
...
tarifaHora: c.tarifa_hora || 0,
tarifaServicio: c.tarifa_servicio,
disponibilidad: {
dias: c.disponibilidad_dias || c.disponibilidad?.dias || [0, 1, 2, 3, 4],
...
tarifa_servicio: conductor.tarifaServicio,
// Disponibilidad
disponibilidad_dias: conductor.disponibilidad?.dias,
disponibilidad_hora_inicio: conductor.disponibilidad?.horaInicio,
disponibilidad_hora_fin: conductor.disponibilidad?.horaFin,
...
tarifaHora: nuevo.tarifa_hora || 0,
...
if (data.tarifaServicio !== undefined) dataParaBackend.tarifa_servicio = data.tarifaServicio;
if (data.estado !== undefined) dataParaBackend.estado = data.estado;
if (data.notas !== undefined) dataParaBackend.notas = data.notas;
...
tarifaHora: actualizado.tarifa_hora || 0,
